...
#execute as @e[tag=mob,tag=mktarget4] run damage @s 3.5 player_attack by @a[scores={rc=1..},tag=mkfire,limit=1,sort=nearest]
tag @e[tag=mktarget4] remove mktarget4

# fin de boucle
execute if score @a[scores={rc=1..,ramdom=4},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.01 ^-0.01 ^0.5 run function weapons:mousket/sneak/mksneak4
execute if score @a[scores={rc=1..,ramdom=5},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.01 ^0.01 ^0.5 run function weapons:mousket/sneak/mksneak4
execute if score @a[scores={rc=1..,ramdom=6},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.01 ^0.01 ^0.5 run function weapons:mousket/sneak/mksneak4
execute if score @a[scores={rc=1..,ramdom=1},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.01 ^-0.01 ^0.5 run function weapons:mousket/sneak/mksneak4
execute if score @a[scores={rc=1..,ramdom=2},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.01 ^-0.01 ^0.5 run function weapons:mousket/sneak/mksneak4
execute if score @a[scores={rc=1..,ramdom=3},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.01 ^0.00 ^0.5 run function weapons:mousket/sneak/mksneak4

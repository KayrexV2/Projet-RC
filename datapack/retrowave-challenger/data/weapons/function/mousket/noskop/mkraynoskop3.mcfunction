...
execute as @e[type=area_effect_cloud,tag=mkray3] at @s unless block ~ ~ ~ #utilitaire:air run particle block{block_state:{Name:cobblestone}} ~ ~ ~ 0.1 0.1 0.1 1 100
...
execute as @e[tag=mob,tag=mktarget3] run damage @s 2.5 utilitaire:bypass by @a[scores={rc=1..},tag=mkfire,limit=1,sort=nearest]
tag @e[tag=mktarget3] remove mktarget3

# fin de boucle
execute if score @a[scores={rc=1..,ramdom=3},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.10 ^-0.02 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
execute if score @a[scores={rc=1..,ramdom=4},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.03 ^0.01 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
execute if score @a[scores={rc=1..,ramdom=5},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.07 ^0.06 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
execute if score @a[scores={rc=1..,ramdom=6},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.08 ^-0.04 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
execute if score @a[scores={rc=1..,ramdom=1},limit=1,tag=mkfire] rc matches 1..35 positioned ^0.11 ^0.02 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
execute if score @a[scores={rc=1..,ramdom=2},limit=1,tag=mkfire] rc matches 1..35 positioned ^-0.01 ^-0.03 ^0.5 run function weapons:mousket/noskop/mkraynoskop3
